...
namespace IQToolkit.Data.Mapping
{
    ...
    public abstract class AdvancedMapping : BasicMapping
    {
        ...
        /// </summary>
        public abstract IReadOnlyList<MappingTable> GetTables(MappingEntity entity);
        ...
        /// </summary>
        public abstract IReadOnlyList<MappingTable> GetExtensionTables(MappingEntity entity);
        ...
        /// </summary>
        public abstract IReadOnlyList<string> GetExtensionKeyColumnNames(MappingTable table);
