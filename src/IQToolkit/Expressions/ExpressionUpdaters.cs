...
namespace IQToolkit.Expressions
{
    ...
    public static class ExpressionUpdaters
    {
        ...
        public static BlockExpression Update(
            this BlockExpression original,
            IEnumerable<ParameterExpression> variables,
            IEnumerable<Expression> expressions)
        {
            if (variables != original.Variables
                || expressions != original.Expressions)
            {
        ...
        public static ConditionalExpression Update(
            this ConditionalExpression original,
            Expression test,
            Expression ifTrue,
            Expression? ifFalse)
        {
            if (test != original.Test
                || ifTrue != original.IfTrue
                || ifFalse != original.IfFalse)
            {
        ...
        public static ConstantExpression Update(
            this ConstantExpression original,
            object? value,
            Type? type)
        {
        ...
        public static DebugInfoExpression Update(
            this DebugInfoExpression original,
        ...
        public static DefaultExpression Update(
            this DefaultExpression original,
            Type type)
        {
        ...
        public static DynamicExpression Update(
            this DynamicExpression original,
            System.Runtime.CompilerServices.CallSiteBinder binder,
            Type returnType,
            IReadOnlyList<Expression> arguments)
        {
            if (binder != original.Binder
        ...
        public static InvocationExpression Update(
            this InvocationExpression original, 
            Expression expression, 
        ...
        public static LabelExpression Update(
            this LabelExpression original,
            LabelTarget target,
        ...
        public static ListInitExpression Update(
            this ListInitExpression original, 
            NewExpression newExpression, 
            IEnumerable<ElementInit> initializers)
        {
            if (newExpression != original.NewExpression 
        ...
        public static LoopExpression Update(
            this LoopExpression original,
            Expression body,
            LabelTarget? breakLabel,
            LabelTarget? continueLabel)
        {
            if (body != original.Body
                || breakLabel != original.BreakLabel
                || continueLabel != original.ContinueLabel)
            {
                ...
                {
                    return Expression.Loop(body, breakLabel);
                }
                else
                {
        ...
        public static MemberInitExpression Update(
            this MemberInitExpression original, 
            NewExpression newExpression, 
            IEnumerable<MemberBinding> bindings)
        {
            if (newExpression != original.NewExpression 
        ...
        public static RuntimeVariablesExpression Update(
            this RuntimeVariablesExpression original,
            IEnumerable<ParameterExpression> variables)
        {
            if (variables != original.Variables)
            {
        ...
        public static SwitchExpression Update(
            this SwitchExpression original,
        ...
        {
            if (switchValue != original.SwitchValue
                || cases != original.Cases
                || defaultBody != original.DefaultBody
        ...
        public static SwitchCase Update(
            this SwitchCase original,
            IEnumerable<Expression> testValues,
            Expression body)
        {
            if (testValues != original.TestValues
                || body != original.Body)
            {
