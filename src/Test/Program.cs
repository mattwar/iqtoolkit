...
namespace Test
{
    class Program
    {
        ...
        {
            //var provider = DbEntityProvider.From(@"..\..\..\..\data\Northwind.mdf", "Test.NorthwindWithAttributes");
            //var provider = DbEntityProvider.From(@"..\..\..\..\data\Northwind.accdb", "Test.NorthwindWithAttributes");
            //var provider = DbEntityProvider.From(@"c:\data\Northwind.mdb", "Test.NorthwindWithAttributes");
            //var provider = DbEntityProvider.From(@"..\..\..\..\data\Northwind.sdf", "Test.NorthwindWithAttributes");            
            //var provider = DbEntityProvider.From("IQToolkit.Data.MySqlClient", "Northwind", "Test.MySqlNorthwind");
            var provider = DbEntityProvider.From("IQToolkit.Data.SQLite", @"..\..\..\..\data\Northwind.db3", "Test.NorthwindWithAttributes");
